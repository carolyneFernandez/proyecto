       ...
       FROM pedidos WHERE codusuario = '".$_SESSION['codusuario']."' AND fechaemision = '".$hoy."'")){
			/*query  para el codpedido ,elija el mayor codpedido con los datos */
				...
				foreach($_SESSION['carrito'] as $id => $objeto){ /*pasarlo como base la variable session carrito por un lado id y objeto*/
					$connection->query("INSERT INTO incluyen VALUES('".$id."', '".$fila['ID']."', '".$objeto['stock']."')"); /*insertar inclyen */
					$connection->query("UPDATE producto SET stock=stock - ".$objeto['stock']." WHERE codproducto = '".$id."'"); /*restar cantidad del producto*/
